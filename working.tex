...
\begin{abstract}
  ...
  model, simulate and predict the impact of \emph{realistically flawed} user behaviours on the emergent properties of
...
for constructing models of socio-technical systems and associated workflows. \Cref{sec:fuzzing} describes the
...
can also be organized hierarchically.  \Cref{fig:workflows} also shows this modularity is exploited for the
...
behavior caused by distraction. \Cref{fig:fuzzing-features} shows scatter plots for the effect of distraction for
