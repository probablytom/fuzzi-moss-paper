...
execution of a workflow can manifest in myriad ways. This paper shows that
deviation in an agent's behaviour is a cross-cutting
concern which can be separated from the workflows they follow, and demonstrates
this via a modelling tool which exploits this separation of concerns, modelling
expected behaviour and deviation from it separately.
\end{abstract}
