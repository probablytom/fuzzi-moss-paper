...
\titlerunning{Modelling Realistic User Behaviour in Information Systems}
...
\begin{abstract}
  ...
  \keywords{User behaviour modelling, simulation, socio-technical systems, dynamic software fuzzing, aspect oriented modelling}
...
study. The domain is modelled as a collection of Python classes, as shown in \Cref{fig:domain}, following an object oriented approach
\cite{omg07omguml}.  
