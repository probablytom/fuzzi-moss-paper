...
UML activity diagrams, BPML \cite{bpml}, YAWL \citep{YAWL}, KaOS \citep{kaos},
i* and \citep{i*}.
...
While workflow is our main concern when searching for candidates to perform fuzzing on, YAWL is largely constructed with a graphical tool, making it difficult to find things to mutate. Ergo, YAWL would be inappropriate as a candidate for fuzzable systems. However, it do
