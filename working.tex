...
\item A demonstration of the efficacy of the framework in a case study comparison of Test Driven Development (TDD) and
  ...
  \citep{Bhat2006TestDrivenDevelopment,George2004TestDrivenDevelopment,Huang2009EmpiricalTestFirstProgramming}.  \todo{I
    think we can remove this, so I've moved it into a Todo note...}  Specifically, the simulation results show that: the
...
techniques for modeling\todo{modeling or modelling? Seems modeling is US?} socio-technical workflows and the limitations
...
\todo{I'll also come back maybe to refer to uses in simulations of
