...
associated tests.  Software systems also record logs of traces of feature
operations and other characteristics implemented as Python properties, including
mean time to failure of historic trace runs.  Developers perform the work on a
...
between the workflow structures and fuzzers chosen.
...
\begin{table}
  ...
  \begin{tabular}{lrlrrrl}
    Work flow & Resources & Fuzzed  & MTF & Remaining PTU & Features & Run time (ms)\\

  \end{tabular}
  \caption{Results for twelve simulation runs of Fuzzi Moss on the software development problem domain.}
  \label{tab:results}
\end{table}
