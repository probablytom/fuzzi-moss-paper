...
\begin{abstract}
  ...
  structure of a workflow and applying fuzzers during execution and a library
...
Workflows direct the sequence of actions by an actor on the artifacts in the
...
the workflow functions is flexible. Workflow functions can be parameterised as
...
particiular run of a software development workflow and subsequent operation.
...
\item The behaviour of TDD would be less susceptable to socio-technical variance
...
driven approach, as well as the presence of incompleted features in the systems
